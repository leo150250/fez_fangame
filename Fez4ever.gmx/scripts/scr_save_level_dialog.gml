...
if (arquivo!=-1) {
    ...
    file_text_write_string(arquivo,string(4));
    file_text_writeln(arquivo);
    ...
    file_text_write_string(arquivo,"=====CUBEBITS");
    file_text_writeln(arquivo);
    file_text_write_string(arquivo,string(instance_number(obj_editor_cubebit)));
    file_text_writeln(arquivo);
    with (obj_editor_cubebit) {
        file_text_write_string(other.arquivo,string(x));
        file_text_writeln(other.arquivo);
        file_text_write_string(other.arquivo,string(y));
        file_text_writeln(other.arquivo);
